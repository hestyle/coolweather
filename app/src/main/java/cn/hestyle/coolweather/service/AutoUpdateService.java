package cn.hestyle.coolweather.service;
...
import cn.hestyle.coolweather.WeatherActivity;
import cn.hestyle.coolweather.gson.Weather;
import cn.hestyle.coolweather.util.HttpUtil;
import cn.hestyle.coolweather.util.Utility;
import okhttp3.Call;
...
public class AutoUpdateService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        // 此方法可能被多次调用，计时service是单例，所以需要取消之前的定时更新任务
